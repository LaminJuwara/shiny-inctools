...
shinyServer(function(input, output, session){
  ...
  incdiff.data <- reactive({  # reactive function for incidence difference
    temp <- incdiff_calc(case = input$case, survey_number = input$survey_number,
                         ...
                         PrevH_3 = input$PrevH_3/100, RSE_PrevH_3 = input$RSE_PrevH_3/100,
                         PrevR_3 = input$PrevR_3/100, RSE_PrevR_3 = input$RSE_PrevR_3/100,
                         MDRI_3 = input$MDRI_3, RSE_MDRI_3 = input$RSE_MDRI_3/100,
                         FRR_3 = input$FRR_3/100, RSE_FRR_3 = input$RSE_FRR_3/100,
                         BigT = input$BigT )
    return(temp)
  ...
  output$tab <- renderTable({
    validate(
      ...
      need(input$RSE_FRR_3 >= 0, 'Please provide a valid RSE for FRR of survey 3'),
      need(input$RSE_FRR_3 <= 100, 'Please provide a valid RSE for FRR of survey 3'),
      need(input$RSE_MDRI_3 >= 0, 'Please provide a valid RSE for MDRI of survey 3'),
      need(input$RSE_MDRI_3, 'Please provide a valid prevalence value for survey 3'),
      need(input$PrevH_3 <= 100, 'Please provide a valid prevalence value for survey 3'),
      need(input$PrevR_3, 'Please provide an prevalence of recent infection value for survey 3'),
      need(input$PrevR_3 >= 0, 'Please provide a valid prevalence of recent infection value for survey 3'),
      need(input$PrevR_3 <= 100, 'Please provide a valid prevalence of recent infection value for survey 3'),
      need(input$RSE_PrevH_3, 'Please provide an RSE of prevalence value for survey 3 '),
      need(input$RSE_PrevH_3 >= 0, 'Please provide a valid RSE of prevalence value for survey 3'),
      need(input$RSE_PrevH_3 <= 100, 'Please provide a valid RSE of prevalence value for survey 3'),
      need(input$RSE_PrevR_3, 'Please provide an RSE of prevalence of recent infection value for survey 3 '),
      need(input$RSE_PrevR_3 >= 0, 'Please provide a valid RSE of prevalence of recent infection value for survey 3'),
      need(input$RSE_PrevR_3 <= 100, 'Please provide a valid RSE of prevalence of recent infection value for survey 3')
    )
    incdiff.data()
